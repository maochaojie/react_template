      ...
      <Row>
        {bgCards.map((color, index) => (
          <Col key={index} lg={4} md={6} sm={6} xs={12} className="mb-3">
            <Card inverse color={color.color}>
              <CardBody>
                <CardTitle className="text-capitalize">
                  {bgCards[color.color]} card title
                </CardTitle>
                <CardText>
                  Some quick example text to build on the card title and make up
                  the bulk of the card's content.
      ...
      <Row>
        {gradientCards.map((color, index) => (
          <Col key={index} lg={4} md={6} sm={6} xs={12} className="mb-3">
            <Card
              inverse
              className={`bg-gradient-${color.color} text-center`}
              style={{ height: 200 }}
            >
              <CardBody className="d-flex flex-column flex-wrap justify-content-center align-items-center">
                <CardTitle>Gradient {color.color} title</CardTitle>
                <CardText>card text</CardText>
              </CardBody>
            </Card>
          </Col>
